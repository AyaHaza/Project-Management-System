...
import 'features/mangement_project/domain_layer/usecases/get_all_project.dart';
...
import 'features/mangement_task/domain_layer/usecases/edit_task_status.dart';
...
Future <void> initializeDependencies()async{
  ...
  sl.registerSingleton<GetAllProjectUseCase>(GetAllProjectUseCase(sl()));
  sl.registerFactory<ProjectBloc>(() =>ProjectBloc(sl(),sl(),sl(),sl()));
  ...
  sl.registerFactory<MangementTaskBlock>(() =>MangementTaskBlock(sl(),sl(),sl()));
